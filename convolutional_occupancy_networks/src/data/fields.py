...
import numpy as np
import trimesh
from convolutional_occupancy_networks.src.data.core import Field
from convolutional_occupancy_networks.src.utils import binvox_rw
from convolutional_occupancy_networks.src.common import coord2index, normalize_coord
