...
import trimesh
from convolutional_occupancy_networks.src.utils import libmcubes
from convolutional_occupancy_networks.src.common import make_3d_grid, normalize_coord, add_key, coord2index
from convolutional_occupancy_networks.src.utils.libsimplify import simplify_mesh
from convolutional_occupancy_networks.src.utils.libmise import MISE
import time
import math
...
class Generator3D(object):
    ...
    def generate_mesh(self, data, return_stats=True):
        ...
        if self.vol_bound is not None:
            ...
            t0 = time.time()
            with torch.no_grad():
                c = self.model.encode_inputs(inputs.reshape(1, 3, 128, 128))
    ...
    def generate_from_latent(self, c=None, stats_dict={}, **kwargs):
        ...
        if self.upsampling_steps == 0:
            ...
            values = self.eval_points(pointsf, c, **kwargs).cpu().tolist()
